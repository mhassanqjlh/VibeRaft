 ...
 * This file demonstrates how to integrate Viberaft with a web frontend
 */

// For React/Vue/Angular applications
export class ViberaftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ViberaftClient(provider, contractAddress);
